...
- `linters.yml` contains various code linters, most of which are powered by [reviewdog](https://github.com/reviewdog/reviewdog). Linters are enabled run for only pull requests by default. 
