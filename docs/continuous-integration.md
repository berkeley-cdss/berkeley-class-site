...
{: .note }
Run `bundle exec rubocop` to run [Rubocop](https://rubocop.org/) (the Ruby linter we use) locally before you push. To autocorrect certain errors, run `bundle exec rubocop --autocorrect`.
